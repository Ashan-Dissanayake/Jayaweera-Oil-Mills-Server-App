...
import com.myproject.JOMServerApp.util.RegexPattern;
...
@Entity
@Table(name = "employee", schema = "jayaweeraoilmills", catalog = "")
public class Employee {
    ...
    @Basic
    @Column(name = "land")
    @Pattern(regexp = "^0\\d{9}$", message = "Invalid Home Number")
    private String land;
    @Basic
    ...
    public boolean equals(Object o) {
        ...
        return Objects.equals(id, that.id) && Objects.equals(number, that.number) && Objects.equals(fullname, that.fullname) && Objects.equals(callingname, that.callingname) && Arrays.equals(photo, that.photo) && Objects.equals(dobirth, that.dobirth) && Objects.equals(nic, that.nic) && Objects.equals(address, that.address) && Objects.equals(mobile, that.mobile) && Objects.equals(land, that.land) && Objects.equals(doassignment, that.doassignment) && Objects.equals(description, that.description);
    }
