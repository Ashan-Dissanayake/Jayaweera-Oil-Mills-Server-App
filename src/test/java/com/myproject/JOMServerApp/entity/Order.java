...
public class Order {
    ...
    public boolean equals(Object o) {
        ...
        if (doplaced != null ? !doplaced.equals(order.doplaced) : order.doplaced != null) return false;
        if (doexpected != null ? !doexpected.equals(order.doexpected) : order.doexpected != null) return false;
        if (expectedgrandtotal != null ? !expectedgrandtotal.equals(order.expectedgrandtotal) : order.expectedgrandtotal != null)
            return false;
